        ...
        <section className="relative flex flex-col justify-center items-center h-screen w-full overflow-hidden bg-[#0a0a0a]">
            ...
            <div className="relative z-10 flex flex-col items-center w-full px-4">
                ...
                <div className="mt-14 flex flex-col items-center gap-8">
                    <div href="#contact" onClick={() => setIsOpen(true)} className="flex items-center cursor-pointer gap-2 px-10 py-5 bg-secondary text-black text-2xl font-semibold rounded-full shadow-lg hover:scale-105 transition-transform">
                        Let&apos;s Connect
                    ...
                    <div className="flex items-center gap-2 text-gray-300 text-xl">
                        ...
                        ayushagrahari0511@protonmail.com
                    </div>
                </div>
            </div>
        </section>
