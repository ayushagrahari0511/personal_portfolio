...
const LeftSidebar = () => {
    ...
    const socialLinks = [
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/ayushagrahari0511',
            icon: (
        ...
        {
            name: 'GitHub',
            url: 'https://github.com/ayushagrahari0511',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <aside className="absolute left-8 top-[15%] flex flex-col items-center z-40 sm:hidden">
            ...
            <div className="flex flex-col items-center">
                {/* Top dot */}
                <div className="w-1 h-1 rounded-full bg-darkText opacity-80"></div>
                
                {/* Vertical line - half screen height */}
                <div className="w-[1px] h-[40vh] bg-darkText opacity-80"></div>
